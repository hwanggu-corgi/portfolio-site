        ...
        return (
            <section className="content content-about">
                ...
                <div class="ml-4 mr-4">
                    <article class="p-6">
                        <h3>Hyungmo Gu</h3>
                        <p> is a dedicated and energetic software developer with 2 years of industry experience living in Vancouver, Canada.</p>
                        ...
                        <p class="small"><i>To my love, whom provided nothing but warmth and support to make this website and my 5 years journey as software developer possible.</i></p>
